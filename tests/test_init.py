...
from calculator.plugins import get_plugin_manager, PluginInterface
# Import these at the top level to avoid the import-outside-toplevel warning
from calculator.plugins.operations import AddPlugin, SubtractPlugin, MultiplyPlugin, DividePlugin
