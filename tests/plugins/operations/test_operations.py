...
import pytest
from calculator.plugins.operations.add import AddCommand, AddPlugin
from calculator.plugins.operations.subtract import SubtractCommand, SubtractPlugin
from calculator.plugins.operations.multiply import MultiplyCommand, MultiplyPlugin
from calculator.plugins.operations.divide import DivideCommand, DividePlugin
